...
const InputWrapper = styled.div`
  ...
  input[type="range"] {
    ...
    &::-moz-range-thumb {
      width: 16px; /* Firefox requires size difference */
      height: 16px;
      background: #A3FF32;
      border: 2px solid #000;
      border-radius: 50%;
...
const MortgageCalculator = () => {
  ...
  useEffect(() => {
    ...
    updateSliderStyle(propertyPriceRef, formData.propertyPrice);
    updateSliderStyle(downPaymentRef, formData.downPayment);
  ...
  return (
    <PageContainer>
      <PageTitle>Ипотечный калькулятор</PageTitle>
      <FormContainer>
        <form onSubmit={handleSubmit}>
          ...
          <FormGroup>
            <label htmlFor="term">Срок ипотеки (лет)</label>
            <InputWrapper>
              <input
                type="number"
                id="term"
